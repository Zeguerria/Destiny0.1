                                     ...
                                     <div class="row">
                                         <div class="col" >
                                             <div class="col" >
                                                ...
                                                <a href="destinatairespdf" data-bs-toggle="tooltip" title="Imprimer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-print" style="font-size: 20px; color:#0682dab4;"></i></a>
                                             </div>
                                         </div>
                                         <div class="col d-flex nav justify-content-end">
