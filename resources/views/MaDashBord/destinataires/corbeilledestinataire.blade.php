                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col  d-flex nav justify-content-end">
                                        @if(in_array("11.2", $droits))
                                            <div class="form-group">
                                                @if(in_array("11.2.1", $droits))
                                                    <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total destinataires"><i class="fa fa-user-circle msicons" style="font-size: 20px;"></i><sup >{{$DestinataireTotal}}</sup></a></label>
                                                @endif
                                                @if(in_array("11.2.2", $droits))
                                                    <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total destinataires corbeille"><i class="fa fa-trash msicons" style="font-size: 20px;"></i><sup >{{$DestinataireTotalC}}</sup></a></label>
                                                @endif
                                            </div>
                                        @endif
                                        <form class="form me-2" role="search" action="{{url('/searchDestinataireCorbeille')}}">
                                            <label for="search">
                                                        ...
                                                        <div class="btn-group">
                                                            <div style="">
                                                                                    ...
                                                                                    @csrf
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="consulter{{$value->id}}"><i class="fas fa-signature msions"></i>&ensp;Nom :</label>
                                                                                                        <input type="text" class="form-control" value="{{$value->nom}}" readonly id="consulter{{$value->id}}" name="codes" placeholder="Entrer le code">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-group">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="consulter{{$value->id}}"><i class="fas fa-signature msicons"></i>&ensp;Prenom :</label>
                                                                                            ...
                                                                                            <div class="row">
                                                                                                <div class="col-sm-4">
                                                                                                    <div class="modal-footer justify-content-between bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                        <button type="button" class="btn btn-block btn-default" data-dismiss="modal"><i class="fas fa-exclamation-triangle msicons"></i>&ensp;Fermer</button>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                </form>
                                                                                    ...
                                                                                    <form method="post" action="{{route('modifierDestinataire')}}">
                                                                                        ...
                                                                                        <!--corp du formulaire debut-->
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    <div class="form-group">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="consulter{{$value->id}}"><i class="fas fa-signature msicons"></i>&ensp;Nom </label>
                                                                ...
                                                                <div class="modal fade" id="corbeille{{$value->id}}">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                            <h4 class="modal-title d-flex"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Restrer le Destinataire : {{$value->nom}} {{$value->prenom}}</h4>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                                        ...
                                                                                        <!--corp du formulaire debut-->
                                                                                            <div class="row">
                                                                                                <div class="col-md-6">
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="supprimer{{$value->id}}"><i class="fas fa-signature msicons"></i>&ensp;Nom </label>
                                                                                                ...
                                                                                                <div class="col-md-6">
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="suprimer{{$value->id}}"><i class="fas fa-signature msicons"></i>&ensp;Prenom </label>
                                    ...
                                    <div class="row">
                                        <div class="col" >
                                            <div class="col" >
                                                ...
                                                <a href="recupAlldestinataire" data-bs-toggle="tooltip" title="Tout Restorer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp;
                                            </div>
                                        </div>
                                        <div class="col d-flex nav justify-content-end">
