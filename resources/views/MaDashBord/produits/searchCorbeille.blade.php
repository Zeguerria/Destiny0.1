    ...
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                <h4 class="modal-title"><span><i class="fas fa-user-plus msicons"></i></span>&ensp;Ajouter un Produit</h4>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-map-marker-alt msicons"></i>&ensp;Nom du Produit</label>
                                            <input type="text" class="form-control" id="" name="nom" placeholder="Entrez le nom du produit">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-map-marked-alt msicons"></i>&ensp;Poids du Produit</label>
                                            <input type="text" class="form-control" id="" name="poids" placeholder="Entrez le poids du produit">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-layer-group msicons"></i>&ensp;Taille du Produit :</label>
                                            <input type="text" class="form-control" id="" name="taille" placeholder="Entrez le nom du produit">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-stream msicons"></i>&ensp;Type de Produit</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-stream msicons"></i>&ensp;Qualité du Produit</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><i class="fas fa-stream msicons"></i>&ensp;Marque du Produit</label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-stream msicons"></i>&ensp;Selectionnez une photo</label>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="col  d-flex nav justify-content-end">
                                        @if(in_array("13.2", $droits))
                                            <div class="form-group">
                                                @if(in_array("13.2.1", $droits))
                                                    <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total vehicules"><i class="fa fa-user-circle msicons" style="font-size: 20px;"></i><sup >{{$ProduitTotal}}</sup></a></label>
                                                @endif
                                                @if(in_array("13.2.2", $droits))
                                                    <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total vehicules corbeille"><i class="fa fa-trash msicons" style="font-size: 20px;"></i><sup >{{$ProduitTotalC}}</sup></a></label>
                                                @endif
                                            </div>
                                        @endif
                                        <form class="form me-2" role="search" action="{{url('/searchProduitCorbeille')}}">
                                            <label for="search">
                                                <input required="" autocomplete="off" placeholder="Rechercher un Produit" name="cherche" id="search" type="text">
                                                <div class="icon">
                                                                ...
                                                                @if(in_array("13.4", $droits))
                                                                    <div class="dropdown">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col">
                                                                                                        <div>
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-archive msicons"></i>&ensp;Nom du Produit</label>
                                                                                                                    <input type="text" class="form-control" value="{{$value->nom}}"  readonly id="" name="nom" placeholder="Entrer le nom">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-balance-scale msicons"></i>&ensp;Poids </label>
                                                                                                                    <input type="text" class="form-control" id="" value="{{$value->poids}}"  name="poids" readonly placeholder="Entrer le Prenom">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-text-width msicons"></i>&ensp;Taille</label>
                                                                                                                    <input type="text" class="form-control" id="" value="{{$value->taille}}"  name="taille" readonly placeholder="Entrer la marque">
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-tag msicons"></i>&ensp;Type du Produit</label>
                                                                                                            ...
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fab fa-markdown msicons"></i>&ensp;Marque du Produit</label>
                                                                                                            ...
                                                                                                            <div class="col-md-12">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fab fa-meetup msicons"></i>&ensp;Qualité du Produit</label>
                                                                                        ...
                                                                                        <div>
                                                                                            ...
                                                                                            <div class="container-fluid">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                        <div class="form-group">
                                                                                                            <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="far fa-image msicons"></i>&ensp;Selectionnez une photo</label>
                                                                                                            <input type="file" class="form-control"  id="" name="photo" placeholder="Entrez le nom du produit">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                        ...
                                                                        <div class="modal fade" id="corbeille{{$value->id}}">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                    <h4 class="modal-title d-flex">Restorer le Produit : {{$value->nom}}</h4>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <span aria-hidden="true">&times;</span>
                                                                                    </button>
                                                                                </div>
                                                                                <div class="modal-body"  style="background: var(--c-color2);">
                                                                                    <form method="post" action="{{route('RecupProduit')}}">
                                                                                            @csrf
                                                                                            <input type="hidden" name="id" value="{{$value->id}}">
                                                                                            <!--corp du formulaire debut-->
                                                                                            <div>
                                                                                            ...
                                                                                            <div class="modal-footer justify-content-between bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                <button type="button" class="btn btn-default" data-dismiss="modal msicons"><i class="fas fa-exclamation-triangle"></i>&ensp;Fermer</button>
                                        ...
                                        <div class="row">
                                            <div class="col" >
                                                <div class="col" >
                                                    ...
                                                    <a href="recupAllproduit" data-bs-toggle="tooltip" title="Tout Restorer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp;
