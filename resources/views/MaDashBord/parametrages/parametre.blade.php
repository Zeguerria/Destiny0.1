                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col  d-flex nav justify-content-end">
                                                @if(in_array("15.2", $droits))
                                                    <div class="form-group">
                                                        @if(in_array("15.2.1", $droits))
                                                ...
                                                @endif
                                                <form class="form me-2" role="search" action="{{url('/searchParametre')}}">
                                                    <label for="search">
                                                                                     ...
                                                                                     <div class="modal fade" id="corbeille{{$value->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                                        ...
                                                                                        <div class="modal-content d-flex">
                                                                                            ...
                                                                                            <div class="modal-body" style="background: var(--c-color2);">
                                                                                                ...
                                                                                                <form method="post" action="{{route('corbeilleParametre')}}" nctype="multipart/form-data">
                                                                                                    @csrf
                                                                                                    <input type="hidden" name="id" value="{{$value->id}}">
                                                                                                    <div>
                                                                                                        <div class="row">
