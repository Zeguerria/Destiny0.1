                                        ...
                                        <div class="row">
                                            <div class="col" >
                                                <div class="col" >
                                                    ...
                                                    <a href="recupAlltypeparametre" data-bs-toggle="tooltip" title="Tout Restorer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp;
                                                </div>
                                            </div>
                                            <div class="col d-flex nav justify-content-end">
