                                  ...
                                  <div class="row">
                                      ...
                                      @if(in_array("9.2.2", $droits))
                                          <div class="col  d-flex nav justify-content-end">
                                              <div class="form-group">
                                                  <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total livreurs"><i class="fa fa-user-circle msicons" style="font-size: 20px;"></i></a><sup >{{$LivreurTotal}}</sup></label>
                                                  <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total livreurs"><i class="fa fa-trash msicons" style="font-size: 20px;"></i></a><sup >{{$LivreurTotalC}}</sup></label>
                                              </div>
