                                     ...
                                     <div class="row">
                                         ...
                                         @if(in_array("9.2.2", $droits))
                                             <div class="col  d-flex nav justify-content-end">
                                                 <div class="form-group">
                                                     <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total users"><i class="fa fa-user-circle msicons" style="font-size: 20px;"></i><sup >{{$LivreurTotal}}</sup></a></label>
                                                     <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total users en corbeille"><i class="fa fa-trash msicons" style="font-size: 20px;"></i><sup >{{$LivreurTotalC}}</sup></a></label>
                                                 </div>
                                                                         ...
                                                                         @if(in_array("9.2.3", $droits))
                                                                             <div class="dropdown">
                                                                                ...
                                                                                <div class="modal fade" id="modifier{{$value->id}}">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                            <h4 class="modal-title">Modifier le Livreur :  {{$value->user->name}} {{$value->user->prenom}}</h4>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <span aria-hidden="true">&times;</span>
                                                                                            </button>
                                                                                        </div>
                                                                                        <div class="modal-body" style="background: var(--c-color2);">
                                                                                            <form method="post" action="{{route('modifierLivreur')}}">
                                                                                                ...
                                                                                                <div class="row">
                                                                                                    <div class="col-md-6">
                                                                                                        <div class="form-group">
                                                                                                            <label for="modifier{{$value->id}}" class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="fas fa-house-user msicons"></i>&ensp;Domicile </label>
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                        ...
                                                                                                        <div class="form-group">
                                                                                                            <label for="modifier{{$value->id}}" class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="far fa-id-card msicons"></i>&ensp;Numero permis</label>
                                                                                                    ...
                                                                                                    <div class="col-md-6">
                                                                                                        <div class="form-group">
                                                                                                            <label for="modifier{{$value->id}}" class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="fas fa-mobile-alt msicons"></i>&ensp;Numero telephone</label>
                                         ...
                                         <div class="container-fluid pt-2">
                                             <div class="row">
                                                 @if(in_array("9.2.4", $droits))
                                                     <div class="col" >
                                                         @if(in_array("9.2.2", $droits))
                                                         <a href="corbeilleAlllivreur" data-bs-toggle="tooltip" title="Vider" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp;
