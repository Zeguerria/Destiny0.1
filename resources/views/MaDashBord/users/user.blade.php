        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                    <h4 class="modal-title fw-bold" style="font-size : 35px; font-weight: 900"><span><i class="fas fa-user-plus msicons"></i></span>&ensp;Ajouter un Utilisateur</h4>
                    ...
                    <form method="post" action="{{route('ajouterUser')}}" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style=" color: var(--color-t); font-family: italic;"><i class="msicons fa fa-audio-description" aria-hidden="true"></i>&ensp;Role</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label style=" color: var(--color-t); font-family: italic;"><i class="fas fa-camera-retro msicons"></i>&ensp;Photo</label>
                                        ...
                                        <div class="row">
                                            ...
                                            @if(in_array("9.2.2", $droits))
                                                <div class="col  d-flex nav justify-content-end">
                                                    <div class="form-group">
                                                        <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total users"><i class="fa fa-user msicons" style="font-size: 20px;"></i></a><sup >{{$UserTotal}}</sup></label>
                                                     <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total users en corbeille"><i class="fa fa-trash msicons" style="font-size: 20px;"></i></a><sup >{{$UserTotalC}}</sup></label>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        @foreach($users as $key => $user)
                                                            <tr class="odd">
                                                                ...
                                                                <td style="">{{$user->pseudo}}</td>
                                                                <td style="">{{$user->email}}</td>
                                                                <td style="">
                                                                    <center>
                                                                        <img src="{{asset($user->le_profil)}}" alt="" class="img img-circle" width="50" height="50">
                                                                    </center>
                                                                </td>
                                                                <td style="">{{$user->role->libelle}}</td>
                                                                <td style="">{{$user->profil->libelle}}</td>
                                                                            ...
                                                                            @if(in_array("9.2.3", $droits))
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list" style="">
                                                                                        <a class="dropdown-item" href="#" data-bs-toggle="tooltip" title="Consulter" data-toggle="modal" data-target="#consulter{{$user->id}}"><i class="fas fa-eye" style="font-size: 20px; color:#0162fdfb;"></i>&ensp;Consulter</a>
                                                                                        <a class="dropdown-item" href="#" data-bs-toggle="tooltip" title="Modifier" data-toggle="modal" data-target="#modifier{{$user->id}}"><i class="fas fa-edit" style="font-size: 20px; color:#a6a806b4;"></i>&ensp;Modifier</a>
                                                                                        <a class="dropdown-item" href="#" data-bs-toggle="tooltip" title="Supprimer" data-toggle="modal" data-target="#corbeille{{$user->id}}"><i class="fas fa-trash" style="font-size: 20px; color:#fc0303b4;"></i>&ensp;Supprimer</a>
                                                                                    </div>
                                                                                    <!--CONSULTER-->
                                                                                    <div class="modal fade" id="consulter{{$user->id}}">
                                                                                        <div class="modal-dialog  modal-lg">
                                                                                            <div class="modal-content"><i class=""></i>
                                                                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                    <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Consulter l'utilisateur : {{$user->name}} {{$user->prenom}}</h4>
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                    <span aria-hidden="true">&times;</span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                    ...
                                                                                                    <form>
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col">
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="fas fa-user-edit msicons"></i>&ensp;Nom </label>
                                                                                                                        <input type="text" class="form-control" value="{{$user->name}}" readonly id="" name="name" placeholder="Entrer le nom">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="fas fa-user-edit msicons"></i>&ensp;Prenom </label>
                                                                                                                        <input type="text" class="form-control" id="" value="{{$user->prenom}}" readonly name="prenom" placeholder="Entrer le Prenom">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="msicons fas fa-user-ninja"></i>&ensp;Pseudo</label>
                                                                                                                        <input type="text" class="form-control" id="" value="{{$user->pseudo}}" readonly name="pseudo" placeholder="Entrer la marque">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="col-md-12">
                                                                                                                    <div class="form-group">
                                                                                                                        <label class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="fas fa-paper-plane msicons"></i>&ensp;Email</label>
                                                                                                                        <input type="email" class="form-control" id="" value="{{$user->email}}" readonly name="email" placeholder="Entrer l'email">
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            ...
                                                                                                            <div class="row">
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <select class="form-control" disabled id="" name="role_id">
                                                                                    ...
                                                                                    <!--MODIFFIER-->
                                                                                    <div class="modal fade" id="modifier{{$user->id}}">
                                                                                        <div class="modal-dialog modal-lg">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                    <h4 class="modal-title"><span><i class="fas fa-user-plus msicons"></i></span>&ensp;Modifier  l'utilisateur : {{$user->name}} {{$user->prenom}}</h4>
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                        <span aria-hidden="true">&times;</span>
                                                                                                    </button>
                                                                                                </div>
                                                                                    ...
                                                                                    <div class="modal fade" id="corbeille{{$user->id}}">
                                                                                        <div class="modal-dialog modal-lg">
                                                                                            <div class="modal-content">
                                                                                                                    ...
                                                                                                                    <div class="container-fluid">
                                                                                                                        <div class="row">
                                                                                                                            <div class="col-md-6">
                                                                                                                                <div class="form-group">
                                                                                                                                    <label class="d-flex " style=" color: var(--color-t); font-family: italic;"><i class="msicons fa fa-audio-description" aria-hidden="true"></i>&ensp;Role</label>
                                                                                                                                    <select class="form-control" id="" disabled name="role_id">
                                                                                                                                        @foreach ($role as $key => $rol)
                                                                                                                                        <option value="{{$rol->id}}" {{($rol->id==$user->role_id)?"selected":""}}>{{$rol->libelle}}</option>
                                                                                                                                        @endforeach
                                                                                                                                    </select>
                                                                                    ...
                                                                                    <!--SUPPRIMER-->
                                                                                    <div class="modal fade" id="supprimer{{$user->id}}">
                                                                                        <div class="modal-dialog modal-lg">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header bg-danger bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                    ...
                                                    @if(in_array("9.2.4", $droits))
                                                        <div class="col" >
                                                            @if(in_array("9.2.2", $droits))
                                                                ...
                                                                <a href="userspdf" data-bs-toggle="tooltip" title="Imprimer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-print" style="font-size: 20px; color:#0682dab4;"></i></a>
                                                            @endif
                                                        </div>
                                                    @endif
                                                    <div class="col d-flex nav justify-content-end">
