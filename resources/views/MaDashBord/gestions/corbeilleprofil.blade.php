...
@section('corps')
    ...
    <div class="content-wrapper lebody masection pb-5" style="min-height: 2080.32px;">
        ...
        @if(in_array("18", $droits))
            <section class="content">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div div class="card cardt">
                                <div class="card-header">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col">
                                                @if(in_array("18.1", $droits))
                                            ...
                                            <div class="col  d-flex nav justify-content-end">
                                                @if(in_array("18.2", $droits))
                                                    <div class="form-group">
                                                        @if(in_array("18.2.1", $droits))
                                                            <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total habilitations"><i class="fa fa-user-circle msicons" style="font-size: 20px;"></i><sup >{{$ProfilTotal}}</sup></a></label>
                                                        @endif
                                                        @if(in_array("18.2.2", $droits))
                                                            <label for=""><a href="#" class="btn " id="" data-bs-toggle="tooltip" title="total habilitations corbeille"><i class="fa fa-trash msicons" style="font-size: 20px;"></i><sup >{{$ProfilTotalC}}</sup></a></label>
                                                        @endif
                                                    </div>
                                                @endif

                                                <form class="form me-2" role="search" action="{{url('/searchProfilCorbeille')}}">
                                                    <label for="search">
                                                                        ...
                                                                        <div style="">
                                                                            @if(in_array("18.4", $droits))
                                                                                ...
                                                                                <div class="modal fade" id="consulter{{$value->id}}">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-headerb bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                            <h4 class="modal-title d-flex"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Consulter le Profil : {{$value->libelle}}</h4>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                            <span aria-hidden="true">&times;</span>
                                                                                            </button>
                                                                                        </div>
                                                                                            ...
                                                                                            <form>
                                                                                                ...
                                                                                                <div>
                                                                                                    <div class="row">
                                                                                                        <div class="col-md-6">
                                                                                                            <div class="form-group">
                                                                                                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;" for="consulter{{$value->id}}"><i class="fa fa-commenting msicons" aria-hidden="true"></i>&ensp;Code :</label>
                                                                                ...
                                                                                <div class="modal fade" id="corbeille{{$value->id}}">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                            <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Restorer le Profil: {{$value->libelle}}</h4>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <span aria-hidden="true">&times;</span>
                                                                                            </button>
                                                                                        </div>
