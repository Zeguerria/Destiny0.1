                    ...
                    <form method="post" action="{{route('ajouterProfilHabilitation')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-tag msicons"></i>&ensp;Profil</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-tag msicons"></i>&ensp;Habilitation</label>
                        ...
                        <div class="modal-footer justify-content-between bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fas fa-exclamation-triangle ion-ios-musical-notes"></i>&ensp;Fermer</button>
            ...
            <div class="col-md-6 col-md-12 bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                ...
                <nav aria-label="breadcrumb" role="navigation" class="d-flex justify-content-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page" >Profils Habilitaion</li>
                    </ol>
                </nav>
            </div>
        </div>
        @if(in_array("19", $droits))
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col  d-flex nav justify-content-end">
                                                ...
                                                <form class="form me-2" role="search" action="{{url('/searchProfilHabilitationCorbeille')}}">
                                                    <label for="search">
                                                ...
                                                <table id="example2" class="table table-bordered table-hover dataTable dtr-inline table-responsive-sm table-striped text-center" data-toggle="table" data-show-columns="true" aria-describedby="example2_info">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Profil</th>
                                                            <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="">Habilitation</th>
                                                                            ...
                                                                            @if(in_array("19.4", $droits))
                                                                                <div class="dropdown">
                                                                                    ...
                                                                                    <div class="modal fade" id="consulter{{$value->id}}">
                                                                                        <div class="modal-dialog  modal-lg">
                                                                                            <div class="modal-content">
                                                                                                <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                    <h4 class="modal-title d-flex"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Consulter le Profil Habilitation du profil : {{$value->profil->libelle}}</h4>
                                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                    <span aria-hidden="true">&times;</span>
                                                                                                    </button>
                                                                                                </div>
                                                                                                                    ...
                                                                                                                    <div class="col-md-6">
                                                                                                                        <div class="form-group">
                                                                                                                            ...
                                                                                                                            <select class="form-control" disabled id="" name="profil_id">
                                                                                                                                @foreach ($profils as $key => $profil_habilitation)
                                                                                                                                <option value="{{$profil_habilitation->id}}" {{($profil_habilitation->id==$value->profil_id)?"selected":""}}>{{$profil_habilitation->libelle}}</option>
                                                                                                                                @endforeach
                                                                                                                            </select>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                                                        ...
                                                                                                                        <div class="form-group">
                                                                                                                            ...
                                                                                                                            <select class="form-control" disabled id="" name="habilitation_id">
                                                                                                                                @foreach ($habilitations as $key => $profil_habilitation)
                                                                                                                                <option value="{{$profil_habilitation->id}}" {{($profil_habilitation->id==$value->habilitation_id)?"selected":""}}>{{$profil_habilitation->libelle}}</option>
                                                                                                                                @endforeach
                                                                                                                            </select>
                                                                                                                        </div>
                                                                                                                    </div>
                                                                                ...
                                                                                <div class="modal fade" id="corbeille{{$value->id}}">
                                                                                    <div class="modal-dialog modal-lg">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                                <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Restorer le Profil Habilitation du profil : {{$value->profil->libelle}}</h4>
                                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                    <span aria-hidden="true">&times;</span>
                                                                                                </button>
                                                                                            </div>
                                                                                            <div class="modal-body" style="background: var(--c-color2);">
                                                                                                <form method="post" action="{{route('recupProfilHabilitation')}}">
                                                                                                        @csrf
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                            <div class="col-md-6">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-tag msicons"></i>&ensp;Profil</label>
                                                                                                                    <select class="form-control" disabled  id="" name="profil_id">
                                                                                                                        @foreach ($profils as $key => $profile)
                                                                                                                        <option value="{{$profile->id}}" {{($profile->id==$value->profil_id)?"selected":""}}>{{$profile->libelle}}</option>
                                                                                                                        @endforeach
                                                                                                                    </select>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                            <div class="col-md-6">
                                                                                                                <div class="form-group">
                                                                                                                    <label class="d-flex" style=" color: var(--color-t); font-family: italic;"><i class="fas fa-tag msicons"></i>&ensp;Habilitation</label>
                                                                                                                    <select class="form-control" disabled id="" name="habilitation_id">
                                                                                                                        @foreach ($habilitations as $key => $habilitatione)
                                                                                                                        <option value="{{$habilitatione->id}}" {{($habilitatione->id==$value->habilitation_id)?"selected":""}}>{{$habilitatione->libelle}}</option>
                                                                                                                        @endforeach
                                                                                                                    </select>
                                                                                                                </div>
                                                                                                            </div>
                                                                                ...
                                                                                <div class="modal fade" id="modifier{{$value->id}}">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header bgnav" style="background-image: url({{asset('mesImages/theme/t1.jpg')}}) ;  background-size: cover; background-repeat: no-repeat;">
                                                                                            <h4 class="modal-title"><span><i class="fas fa-user-secret msicons"></i></span>&ensp;Supprimer le Profil Habilitation du profil : {{$value->profil->libelle}}</h4>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <span aria-hidden="true">&times;</span>
                                                                                            </button>
                                                                                        </div>
                                                                                    ...
                                                                                    <div class="modal-dialog modal-lg">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header bg-black">
                                                                                                <h4 class="modal-title"><span><i class="fas fa-tag msicons"></i></span>&ensp;Supprimer le Profil Habilitation du profil : {{$value->profil->libelle}}</h4>
                                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                    <span aria-hidden="true">&times;</span>
                                                                                                </button>
                                                                                            </div>
                                        ...
                                        <div class="clearfix p-1">
                                            <div class="container-fluid pt-2">
                                                <div class="row">
                                                    <div class="col" >
                                                        <div class="col" >
                                                            {{-- <a href="deleteAllprofilhabilitation" data-bs-toggle="tooltip" title="Tout Vider" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fa fa-trash" style="font-size: 20px; color:#ff0000;"></i></a>&emsp; --}}
                                                            {{-- {{-- <a href="recupAllprofilhabilitation" data-bs-toggle="tooltip" title="Tout Restorer" class="btn btn-sm code-copy pull-left" data-clipboard-target="#basic-table-code"><i class="fas fa-sync-alt" style="font-size: 20px; color:#3300ff;"></i></a>&emsp; --}} --}}
                                                        </div>
                                                    </div>
                                                    <div class="col d-flex nav justify-content-end">
